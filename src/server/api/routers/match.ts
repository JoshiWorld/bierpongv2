...
export const matchRouter = createTRPCRouter({
  enterResultGroup: protectedProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      const { matchId, team1Cups, team2Cups, winnerId, team1Id, creatorId } = input;
    ...
    getMatchesFromTeam: protectedProcedure.input(z.object({ teamId: z.string() })).query(({ ctx, input }) => {
